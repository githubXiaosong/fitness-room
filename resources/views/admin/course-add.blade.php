...
<div class="x-body">
    ...
    <form class="layui-form" action="{{ url('admin/api/addCourse') }}" method="post">
        {{ csrf_field() }}

        <div class="layui-form-item">
            <label for="L_title" class="layui-form-label">
                <span class="x-red">*</span>课程标题
            </label>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline  {{ $errors->has('desc') ? 'error-input' : '' }}">
                <input type="text" name="desc" required="" id="name"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="room_id" id="room_id" class="layui-input">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline  {{ $errors->has('time') ? 'error-input' : '' }}">
                <input type="datetime" name="time" required="" id="time"
                       autocomplete="off" class="layui-input" value="{{ old('time') }}" placeholder="请点击选择" autofocus>
            </div>
            @if ($errors->has('time'))
                <span class="help-block error-text">
