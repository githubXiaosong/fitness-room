    ...
    <table class="layui-table">
        ...
        @foreach($users as $user)
            <tr>
                ...
                <td class="td-status">
                    <span class="layui-btn {{$user->status==STATUS_NORMAL?:'layui-btn-normal'}} layui-btn-mini">{{ $user->status==STATUS_OFF_NORMAL?'未启用':'已启用'}}</span>
                </td>
                ...
                <td class="td-manage">
                    ...
                    <a title="编辑" href="{{ url('admin/memberEdit/'.$user->id) }}">
